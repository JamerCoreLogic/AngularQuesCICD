...
@Component({
  selector: 'app-adjuster-list',
  templateUrl: './adjuster-list.component.html',
  styleUrls: ['./adjuster-list.component.scss'],
})
export class AdjusterListComponent implements OnInit,OnChanges {
  @Input() adjusters: any[] = [];
...
this.subscriptions.add(
  ...
  viewNotification(adjuster:any): void {
    ...
    initiateRequest() {
      ...
      this.router.navigate(['/main/initiatesurvey'] , { queryParams: { module: 'Adjuster' }});
