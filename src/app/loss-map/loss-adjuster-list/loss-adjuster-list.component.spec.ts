...
import { LossAdjusterListComponent } from './loss-adjuster-list.component';
import { SharedMaterialModule } from 'src/app/shared-material/shared-material.module';
import { FilterListComponent } from 'src/app/find-adjuster/filter-list/filter-list.component';
import { LossViewProfileComponent } from '../loss-view-profile/loss-view-profile.component';


describe('LossAdjusterListComponent', () => {
  let component: LossAdjusterListComponent;
  let fixture: ComponentFixture<LossAdjusterListComponent>;
  ...
  beforeEach(async () => {
    ...
    await TestBed.configureTestingModule({
      ...
      declarations: [LossAdjusterListComponent, FilterListComponent],
      providers: [
  ...
  beforeEach(() => {
    ...
    fixture = TestBed.createComponent(LossAdjusterListComponent);
  ...
  it('should open ViewProfileComponent dialog when viewProfile is called', () => {
    ...
    expect(dialogSpy.open).toHaveBeenCalledWith(LossViewProfileComponent, {
