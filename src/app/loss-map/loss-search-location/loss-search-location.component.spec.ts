...
import { LossSearchLocationComponent } from './loss-search-location.component';
import { SharedAdjusterService } from 'src/app/services/shared-adjuster.service';

describe('LossSearchLocationComponent', () => {
  let component: LossSearchLocationComponent;
  let fixture: ComponentFixture<LossSearchLocationComponent>;
  ...
  beforeEach(async () => {
    ...
    await TestBed.configureTestingModule({
      ...
      declarations: [LossSearchLocationComponent],
      providers: [
    ...
    fixture = TestBed.createComponent(LossSearchLocationComponent);
