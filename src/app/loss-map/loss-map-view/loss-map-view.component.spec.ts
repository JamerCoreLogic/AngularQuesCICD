...
import { LossMapViewComponent } from './loss-map-view.component';
import { LossViewProfileComponent } from '../loss-view-profile/loss-view-profile.component';

describe('LossMapViewComponent', () => {
  let component: LossMapViewComponent;
  let fixture: ComponentFixture<LossMapViewComponent>;
  ...
  beforeEach(async () => {
    ...
    await TestBed.configureTestingModule({
      declarations: [LossMapViewComponent],
  ...
  beforeEach(() => {
    fixture = TestBed.createComponent(LossMapViewComponent);
  ...
  it('should open info window with correct data', () => {
    ...
    expect(dialog.open).toHaveBeenCalledWith(LossViewProfileComponent, {
  ...
  it('should add legend to map without errors', () => {
    const pushSpy = jasmine.createSpy('push');
    component.map = {
      googleMap: {
        controls: {
    ...
    // Should call push method without errors
    expect(pushSpy).toHaveBeenCalled();
  });
