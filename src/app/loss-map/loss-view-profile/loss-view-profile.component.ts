...
@Component({
  selector: 'loss-view-profile',
  templateUrl: './loss-view-profile.component.html',
  styleUrls: ['./loss-view-profile.component.scss']
})
export class LossViewProfileComponent implements OnInit,AfterViewInit {
  qustionList: any;
  viewProfile: any;
  deploymentData:any;
  ...
  constructor( public dialogRef: MatDialogRef<LossViewProfileComponent>,private as: AdjustersService,private fb: FormBuilder,
