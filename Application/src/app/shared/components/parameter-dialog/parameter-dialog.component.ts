...
import { Validators, UntypedFormControl, FormGroup, FormBuilder } from '@angular/forms';
...
export class ParameterDialogComponent implements OnInit {
  ...
  createDialogForm() {
    ...
    this.ParameterForm = this.fb.group({
      FullName: new UntypedFormControl('', [Validators.required, Validators.maxLength(100), this.noWhitespaceValidator,]),
