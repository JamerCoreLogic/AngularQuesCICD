...
@Component({
    selector: 'lib-quote-list-view',
    template: `
  <div class="ql-cont-inner">
  <div class="qlist-table-header">
    <div class="qth-left">
      <span *ngIf="Pagination"><input type="text" class="greybg-input" placeholder="Search45" [(ngModel)]="searchText" (keyup)="filter(searchText)" /></span>
    </div>
    <div  class="qth-right">
