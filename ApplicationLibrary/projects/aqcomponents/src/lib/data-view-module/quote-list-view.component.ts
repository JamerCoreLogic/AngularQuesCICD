...
@Component({
  ...
  <div class="qlist-table-header">
    ...
    <div  class="qth-right">
      <div> <span *ngIf="AdvanceFilterEnabled" class="advancefilterbtn" (click)="clearAll()" >Clear Filter</span>
      <span *ngIf="AdvanceFilterEnabled" class="advancefilterbtn" (click)="OpenFilter()">Advanced Filter</span> </div>
