...
@Component({
  ...
  <div class="qlist-table-header">
    ...
    <div  class="qth-right">
    <span *ngIf="AdvanceFilterEnabled" class="advancefilterbtn" (click)="clearAll()">Clear Filter</span>
      <span *ngIf="AdvanceFilterEnabled" class="advancefilterbtn" (click)="OpenFilter()">Advanced Filter</span>
          <div *ngIf="IsCheckboxEnable" class="business-search">
            <div class="form-group" >
          <label class="textbox_borderlabel">Transfer to</label>
          <select class="form-control dropdown_border"  (change)="selectAgent($event.target.value)" >
        ...
        <button *ngIf="IsCheckboxEnable" [disabled]="!isValidTransfer" type="submit" (click)="transferBusiness()" class="btn-theme fix_width">
        Transfer
        </button>
      </div>
