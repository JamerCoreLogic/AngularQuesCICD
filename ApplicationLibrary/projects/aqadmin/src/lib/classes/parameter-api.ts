...
export class ParameterApi {
    private _getParameterApi = '/api/Parameters/GetParameterData';
    private _getAllParameterData = '/api/Parameters/GetAllParameterData';
    private _getZipDetailsApi = '/api/insured/CityStateLookUp';
    private _ValidateAddressApi = '/api/insured/ValidateAddress';
    private _validateAddressFieldApi = '/api/Address/ValidateAddress'
    private _MGAProgramsApi = '/api/MGA/GetMGAPrograms';
    private _GetConfigurationApi = '/api/MGA/GetConfiguration';
    private _parameterKeysListApi = "/api/parameters/getparameterkey";
    private _saveParameterApi = "/api/parameters/Saveparameterdata";
    private _downloadParameterApi = "/api/Parameters/DownloadParameter";
    private _saveParameterDialog = "/api/Parameters/SaveParameter";
    private _getParameterScreenApi = "/api/Parameters/GetAllParameterData";
    private _getParameterKeyApi = "/api/Parameters/SaveParameterKey";
